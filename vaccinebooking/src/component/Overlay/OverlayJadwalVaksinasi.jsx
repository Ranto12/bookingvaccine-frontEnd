...
const Overlaybookingvacinne = ({ Number, nama, stock, jenis, waktu }) => {
    ...
    return (
        <div >
            <div onClick={handleClikPopUp} className="btn-popUp">  <RiPencilFill /></div>
                            ...
                            <div className=' popUp-content Absolute-position '>
                                <div className='row mb-5 modal-dialog-centered'>
                                    <div className='justify-content-center'>
                                        ...
                                        <div className='title-Head me-5 ms-5'>Stock</div>
                                        <div className='title-body me-5 ms-5'>{stock}</div>
                                        <div className='Br-inline me-5 ms-5'></div>
                                        <div className='title-Head me-5 ms-5'>Jenis Vaksin</div>
                                        <div className='title-body me-5 ms-5'>{jenis}</div>
                                        <div className='Br-inline me-5 ms-5'></div>
                                        ...
                                        <div className='title-body  me-5 ms-5 '>
                                            ...
                                            <TableDetailPemesanan nama={nama} jenisVaccine={jenis} Number={Number} />
                                        </div>
                                    </div>
                                </div>
